...
import 'package:ethosv2/common/helper/last_seen_message.dart';
...
import 'package:ethosv2/feature/chat/widget/custom_list_tile.dart';
            ...
            child: Column(
              children: [
                ...
                ListTile(
                  ...
                  title: const Text('Hey there! I am using CYLO'),
                  subtitle: Text(
                    '17th February',
                    style: TextStyle(
                      color: context.theme.greyColor,
